<h5><a href="index.php?r=course/view/<?php echo $class['id']; ?>"><?php echo $class['name']; ?></a></h5>
...
<strong>Open Seats:</strong> <?php echo $class['enrollment_cap'] - $class['curr_enroll'] ." / " . $class['enrollment_cap']; ?>
